...
OUT_EMM = "emm_by_chirality_time.csv"
OUT_CONTR = "contrasts_by_chirality_fdr.csv"
OUT_FIG = "chirality_trajectories_emm_ci.png"
...
if WITHIN_CHIRALITY_ZSCORE:
    # set observed=False explicitly to avoid future pandas warning
...
for chir in chiralities:
    for t in time_levels:
        ...
        # ensure categorical types match model
